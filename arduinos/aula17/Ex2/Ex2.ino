...
void loop() {
  ...
  bool SEV = digitalRead(pin_b1); //pin_botaoA esta com o nome de "SEV"
  bool SSV = digitalRead(pin_b2); //pin_botaoB esta com o nome de "SSV"
  bool BOT = digitalRead(pin_b3); //pin_botaoC esta com o nome de "BOT"
